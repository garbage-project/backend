...
public class Member extends TableImpl<MemberRecord> {
     ...
     */
    public final TableField<MemberRecord, String> MBR_EMAIL = createField(DSL.name("MBR_EMAIL"), SQLDataType.VARCHAR(30).nullable(false), this, "이메일");
     ...
     */
    public final TableField<MemberRecord, String> MBR_SCL_ID = createField(DSL.name("MBR_SCL_ID"), SQLDataType.VARCHAR(30).nullable(false), this, "소셜 ID");
    ...
    /**
     * The column <code>trash.MEMBER.CRD_DTM</code>. 등록일시
     */
    public final TableField<MemberRecord, LocalDateTime> CRD_DTM = createField(DSL.name("CRD_DTM"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "등록일시");
