...
public class MemberRecord extends UpdatableRecordImpl<MemberRecord> {
    ...
    /**
     * Setter for <code>trash.MEMBER.CRD_DTM</code>. 등록일시
     */
    public MemberRecord setCrdDtm(LocalDateTime value) {
        set(8, value);
        return this;
    }
     ...
     */
    public MemberRecord(ULong mbrSeq, String mbrEmail, String mbrNm, String mbrGndr, String mbrBrdt, String mbrSclId, String mbrSclTyp, String mbrVldYn, LocalDateTime crdDtm, LocalDateTime updDtm) {
        super(Member.MEMBER);
